...
class RequestHandler extends Handler {
    ...
    public void handleMessage( Message message) {
      ...
      final Messenger replyMessenger= requestMessage.getMessenger();
        ...
        // TODO -- you fill in here.
        final String directory_pathname=requestMessage.getDirectoryPathname();
        ...
        final Runnable downloadImageAndReply = 
            new Runnable() {
                ...
                public void run() {
                	...
                	final Uri pathname = Utils.downloadImage(mService.get(), imageuri, directory_pathname);

                    // Send the path to the image file, url, and
                    // requestCode back to the Activity via the
                    // replyMessenger.
                    // TODO -- you fill in here.
                	sendPath(replyMessenger,pathname, imageuri, requestcode);
                }
            };
